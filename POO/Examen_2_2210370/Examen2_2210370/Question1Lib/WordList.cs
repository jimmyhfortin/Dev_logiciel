...
public class WolrList
{
    public string Name { get; set; }
    public List<string> Words { get; set; }
    public int Count { get; set; }

    public WolrList(String name)
    {
        Name = name;
    }

    public WolrList(String name, List<string> words)
    {
        Name = name;
        Words = words;
    }

    public WolrList(String name, params string[] words)
    {
        Name = name;
        Words = new List<string>(words);
    }

    public WolrList(string name, List<string> words, int count)
    {
        Name = name;
        Words = words;
        Count = count;
    ...
    public WolrList(string name, string filename)
    {
        Name = name;
